## documentation link is same as before : https://registry.terraform.io/modules/terraform-aws-modules/security-group/aws/latest
...
module "security_group" {
  ...
  #db_option_group_name_prefix = "ThreeTier"
...
# documentation https://registry.terraform.io/modules/terraform-aws-modules/rds/aws/6.1.0
...
module "rds" {
  ...
  option_group_name        = var.option_group_name_rds
  option_group_description = var.option_group_description_rds
  ...
  multi_az               = var.rds_multi_az #set this to true if failover instance is required
